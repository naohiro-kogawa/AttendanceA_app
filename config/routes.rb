Rails.application.routes.draw do
  ...
  resources :users do
    member do
      get  'users/:id/edit_basic_info',to:'users#edit_basic_info',as:'edit_basic_info' # 基本情報更新のページ
      get  '/users/working_users', to: 'users#working_users',as:'users_working_users' # 出勤中社員一覧のページ
